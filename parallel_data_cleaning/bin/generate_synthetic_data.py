...
def main():
    parser = argparse.ArgumentParser()
    parser.add_argument('-s', '--src_path', help='source path', default='toy_corpus/src.en', required=True)
    parser.add_argument('-t', '--tgt_path', help='target path', default='toy_corpus/tgt.de', required=True)
    parser.add_argument('-os', '--out_path_src', help='output path source', default='output/src.neg.en', required=True)
    parser.add_argument('-ot', '--out_path_tgt', help='output path target', default='output/tgt.neg.en', required=True)
